  ...
  return (
    <>
      <SeoHeadComponent
        ...
        path="/contact"
        image="/img/home/thursday-1.webp"
        breadcrumbs={[
          { name: "Accueil", path: "/" },
      ...
      <div className="relative">
        ...
        <div ref={heroRef}>
          <BannerComponent
            ...
            eyebrow="Contact"
            description="Une question, une demande particulière ou une réservation de groupe ? L’équipe Jacasse vous répond rapidement."
            imgUrl="home/thursday-1.webp"
          />
        </div>
