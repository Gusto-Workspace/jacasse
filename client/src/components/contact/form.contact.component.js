...
export default function FormContactCompnent() {
  ...
  return (
    <section className="w-full">
      <div className="rounded-[16px] border border-[rgba(20,72,47,0.14)] bg-[rgba(255,255,255,0.45)] p-6 shadow-[0_18px_50px_rgba(19,24,20,0.08)] backdrop-blur-[10px] tablet:p-8 desktop:p-9">
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              >
                <div className="relative">
                  <select
                    id="contact-subject"
                    defaultValue=""
                    className="site-input h-[56px] w-full appearance-none px-4 pr-12 text-[15px] text-[var(--site-ink-soft)] tablet:text-[16px]"
                    {...register("subject", {
                  ...
                  >
                    ...
                    <option value="Réservation de groupe">
                  ...
                  <ChevronDown
                    size={18}
                    strokeWidth={1.8}
                    className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 text-[var(--site-ink)]"
                  />
                </div>
              </Field>
            </div>
            ...
            <div className="flex flex-col gap-4 pt-1">
              ...
              <button
                ...
                className="site-button min-w-[220px] gap-3 disabled:cursor-not-allowed disabled:opacity-70"
              >
                {isSubmitting ? (
                  <>
...
function Field({ label, fieldId, error, children }) {
  return (
    <div>
      <label
        htmlFor={fieldId}
        className="mb-3 block text-[11px] font-semibold uppercase tracking-[0.24em] text-[var(--site-ink)]"
      >
        {label}
      </label>
      {children}
